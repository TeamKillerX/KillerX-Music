...
- Setup configs
    - Download the sample config file <br>
        ...
        - ```wget https://raw.githubusercontent.com/TeamKillerX/KillerX-Music/dev/config.env.sample -O config.env```
        - ```vim config.env```
    - Download the yml file for docker-compose
        - ```wget https://raw.githubusercontent.com/TeamKillerX/KillerX-Musix/dev/docker-compose.yml```
